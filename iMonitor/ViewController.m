...
#define kFirechatNS @"https://ptsdeeznuts.firebaseio.com/"
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary* chat = [self.chat objectAtIndex:[indexPath row]];
    if (![[chat objectForKey:@"name"] hasPrefix:@"Dr"] && [self.name hasPrefix:@"Dr"]) {
        [self.navigationController pushViewController:[self.storyboard instantiateViewControllerWithIdentifier:@"patient"] animated:YES];
    }
